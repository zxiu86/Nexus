    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                // Release notes box
                Text(
                    text = if (updateInfo.updateAvailable) "ما الجديد في هذا الإصدار:" else "مميزات الإصدار الأخير (v1.6.2):",
                ...
                Surface(
                    ...
                    Column(
                        ...
                        val notes = if (updateInfo.releaseNotes.isNotBlank()) {
                            ...
                            "• واجهة هيدر نقية وعصرية: تركيز كامل على شعار NEXUS مع التنقل السلس عبر الفوتر.\n• الخط العربي الأميري: اعتماد الخط العربي الأصيل في كافة واجهات التطبيق.\n• القراءة بدون إنترنت: إمكانية تحميل الفصول مسبقاً وتخزينها محلياً بشكل مشفر.\n• وضع القراءة المغمور (Immersive Mode): إخفاء شريط الحالة وشريط التنقل لتجربة شاشة كاملة.\n• التكبير والتصغير التفاعلي (Pinch-to-zoom) بسلاسة فائقة.\n• الحماية الأمنية ومنع لقطات الشاشة (FLAG_SECURE).\n• تتبع التقدم وسجل القراءة التلقائي لآخر صفحة تم التوقف عندها.\n• شريط تنقل سفلي فاخر (Footer) للتنقل السريع بين الأقسام."
                        }
                        Text(
                            text = notes,
